                          ...
                          @method('PUT')
                            ...
                            <div class="p-2 w-1/2 mx-auto">
														...
														<div class="p-2 w-1/2 mx-auto flex justify-between mt-4">
															<button type="button" onclick="location.href='{{ route('admin.owners.index') }}'" class="bg-gray-200 bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
