...
class Product extends Model
{
    ...
    public function imageFirst() //imageFirstはimage1のこと
    {
      return $this->belongsTo(Image::class, 'image1', 'id');
    }

    public function imageSecond() //imageFirstはimage1のこと
    {
      return $this->belongsTo(Image::class, 'image2', 'id');
    }

    public function imageThird() //imageFirstはimage1のこと
    {
      return $this->belongsTo(Image::class, 'image3', 'id');
    }

    public function imageFourth() //imageFirstはimage1のこと
    {
